    ...
    <section id="services" className="services">
      <div className="services-container">
        ...
        <div className="services-grid">
          ...
          <div className="service-card">
            <h3 className="service-card-title">XR / VR Game Development</h3>
            <p className="service-subtitle">Experience Gaming Beyond Screens.</p>
            <p>We create immersive XR and VR experiences for futuristic storytelling and gameplay.</p>
            <ul className="service-items">
              <li>Oculus, HTC Vive & WebXR Platforms</li>
              <li>VR Game Design & Prototyping</li>
              <li>XR for Simulation, Education & Training</li>
